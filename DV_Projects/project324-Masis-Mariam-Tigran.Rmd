---
subject: IESM324
title: Influence of People's Age on Reading Frequency over the years considering interfering
  factors
author: "Mariam Manukyan, Masis Sarkis Sarkissian, Tigran Markosyan"
date: "2024-10-12"
---

Data is taken from Kaggle: https://www.kaggle.com/datasets?search=book+readers

Hypothesis:
- H₀ (Null Hypothesis): Fiction is not more popular among ages 15–40 compared to other genres.
- H₁ (Alternative Hypothesis): Fiction is more popular among ages 15–40 compared to other genres.

Data: 
- We have data collected for 3524 readers.
...
First, we wrote codes to filter and remove the rows were we have 
* We filter Age column NA values
